...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', dest='infolder', help="full path of the folder with vcf files per chromosome [required]", required=True)
    ...
    vcflist=["I="+args.infolder+"/"+f+" " for f in vcf]
